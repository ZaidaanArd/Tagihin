  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-danger-text text-white hover:bg-[#7a2c14]",
        outline:
          "border border-border bg-bg-card text-text-primary hover:bg-neutral-bg",
        secondary: "bg-primary-light text-primary-dark hover:bg-primary/20",
        ghost: "text-text-secondary hover:bg-neutral-bg",
